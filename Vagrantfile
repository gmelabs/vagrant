...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "nodo_test" do |conf1|
    ...
    conf1.vm.network "forwarded_port", guest: 8080, host: 58080
  ...
  config.vm.define "nodo_certif" do |conf2|
    ...
    conf2.vm.network "forwarded_port", guest: 8080, host: 58081
  ...
  config.vm.define "nodo_prod" do |conf3|
    ...
    conf3.vm.network "forwarded_port", guest: 8080, host: 58082
